 ...
 * Contains full delivery info, seller/buyer contact, pickup/delivery locations,
...
public class ShipperDeliveryDetailResponse {
    ...
    public ShipperContactInfoDto getSeller() {
        return seller;
    }

    public void setSeller(ShipperContactInfoDto seller) {
        this.seller = seller;
    }

    public ShipperContactInfoDto getBuyer() {
        return buyer;
    }

    public void setBuyer(ShipperContactInfoDto buyer) {
        this.buyer = buyer;
    }

    public ShipperPickupLocationDto getPickup() {
        return pickup;
    }

    public void setPickup(ShipperPickupLocationDto pickup) {
        this.pickup = pickup;
    }

    public ShipperDeliveryLocationDto getDelivery() {
        return delivery;
    }
    ...
    public void setTimeline(ShipperDeliveryTimelineDto timeline) {
        this.timeline = timeline;
    }

    public ShipperDeliveryActionsDto getActions() {
        return actions;
    }

    public void setActions(ShipperDeliveryActionsDto actions) {
        this.actions = actions;
    }
}
